...
public class WordCloudBuilder {
    ...
    public static WordCloud buildWordCouldByWordFrequencies(int width_img, int height_img, int angle_word, int maxFont,
    ...
    public  static List<WordFrequency> buildWordFrequencies(List<String> words) {
